...
describe 'Projects API', type: :request do  
  ...
  describe "GET /projects/:id" do
    it "shows the project" do
      ...
      get "/projects/#{project.id}", params: { id: project.id }
  ...
  describe "POST /projects" do
    context "with valid params" do
      it "creates a new project" do
        expect do
          post "/projects", params: { project: valid_attributes }
    ...
    context "with invalid params" do
      it "respond with error" do
        post "/projects", params: { project: invalid_attributes }
  ...
  describe "PUT /projects/:id" do
    context "with valid params" do
      ...
      it "updates the requested project" do
        project = FactoryGirl.create :project
        put "/projects/#{project.id}", params: { id: project.to_param, project: new_attributes }
        project.reload
    ...
    context "with invalid params" do
      it "respond with error" do
        project = FactoryGirl.create :project
        put "/projects/#{project.id}", params: { id: project.to_param, project: invalid_attributes }
        expect(response.status).to eq(422)
      end
    end
  end
  ...
  describe "DELETE /projects/:id" do
    it "destroys the requested project" do
      project = FactoryGirl.create :project
      expect do
        delete "/projects/#{project.id}", params: { id: project.to_param }
      end.to change(Project, :count).by(-1)
